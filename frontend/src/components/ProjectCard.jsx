        ...
        <CardContent className="p-0 relative">
          <div className="relative aspect-[4/3] sm:aspect-video overflow-hidden bg-muted">
            {project.image ? (
              ...
              <div className="w-full h-full bg-gradient-to-br from-black to-zinc-900 flex items-center justify-center transform group-hover:scale-105 transition-transform duration-700 ease-in-out">

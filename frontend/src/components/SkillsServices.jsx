...
import { MonitorPlay, PenTool, Layers, Film, Code, Camera, Brush, Zap, Globe, Music, BookOpen, Box } from "lucide-react";
import { useEffect, useState } from "react";
import api from "../api";

// Map of icon name strings → actual Lucide components
const ICON_MAP = {
  Film, Layers, PenTool, MonitorPlay, Code, Camera, Brush, Zap, Globe, Music, BookOpen, Box,
};

const DEFAULT_SKILLS = ['Adobe Premiere Pro', 'After Effects', 'DaVinci Resolve', 'Final Cut', 'Photoshop', 'Illustrator', 'Figma', 'Cinema 4D', 'Blender'];
const DEFAULT_SERVICES = [
  { iconName: 'Film', title: 'Video Editing', desc: 'Cinematic cuts, color grading, and audio syncing for YouTube, commercials, and short films.' },
  { iconName: 'Layers', title: 'Motion Graphics', desc: 'Dynamic text animations, lower thirds, and impactful intros built in After Effects.' },
  { iconName: 'PenTool', title: 'Brand Identity', desc: 'Logo design, typography sets, and modern brand guidelines crafted for the digital era.' },
  { iconName: 'MonitorPlay', title: 'Web Graphics', desc: 'High-converting thumbnails, social media kits, and UI marketing assets.' },
];
    ...
    <section id="skills" className="py-20 border-t border-white/5 relative">
      <div className="grid lg:grid-cols-3 gap-12">
        ...
        <div className="lg:col-span-2 grid sm:grid-cols-2 gap-6">
          {services.map((svc, i) => {
            const IconComponent = ICON_MAP[svc.iconName] || Film;
            return (
